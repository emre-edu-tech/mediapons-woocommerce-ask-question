document.addEventListener('DOMContentLoaded', () => {
    ...
    questionForm.addEventListener('submit', (event) => {
        ...
        // Custom DOM element id can not be passed to turnstile.reset() function
        // Only Cloudflare Turnstile Widget ID that is generated by Turnstile can be passed to that function
        ...
        .finally(() => {
            ...
            // Only reset turnstile widget if Cloudflare Turnstile JS is loaded
            if(window.turnstile) {
